...
# Stable Guide identity for the existing Ops Live definitions.  Category,
# subgroup, and display text continue to come from the addOpsLayer() source
# below; this compact seam supplies only the durable key and build flag that
# those browser-side definitions historically lacked.
pt_ops_live_guide_identity_registry <- function() {
  source_token <- c(
    ...
    "Reservoirs | storage-centric | CDEC / CNRFC / USACE",
    "NWS weather stations | NWS/WRH time series",
    "QPE | NWS MRMS 1-hr",
    "QPE | NWS MRMS 1-day",
    "QPE | NWS MRMS 3-day",
    ...
    "Wind flow | NOAA HRRR surface detail",
    "Wind flow | NOAA GFS surface",
    "Wind outlook | NOAA NBM guidance",
    "PT_ASOS_WIND_LAYER_NAME",
    "PT_SNOW_PRODUCT_NAME",
    "PT_QPF_PRODUCT_NAME",
    "PT_ACCUM_PRODUCT_NAME"
  )

  stable_id <- c(
    "ops_alertcalifornia_cameras",
    "ops_alertcalifornia_viewsheds",
    "ops_radar_iem_nexrad",
    "ops_radar_noaa_mrms",
    "ops_goes_geocolor",
    "ops_goes_infrared",
    ...
    "ops_major_water_supply_forecasts",
    "ops_cdec_reservoir_storage",
    "ops_nws_weather_stations",
    "ops_qpe_mrms_1hr",
    "ops_qpe_mrms_1day",
    "ops_qpe_mrms_3day",
    "ops_qpe_rfc_1day",
    ...
    "ops_wpc_qpf_3day",
    "ops_wpc_qpf_7day",
    "ops_nws_watches_warnings_advisories",
    "ops_wpc_ero_day_1",
    "ops_wpc_ero_day_2",
    "ops_wpc_ero_day_3",
    "ops_nws_wfo_boundaries",
    "ops_us_drought_monitor",
    "ops_cpc_6_10_temperature",
    "ops_cpc_6_10_precipitation",
    "ops_cpc_8_14_temperature",
    "ops_cpc_8_14_precipitation",
    "ops_hrrr_surface_wind",
    "ops_gfs_surface_wind",
    "ops_nbm_wind_guidance",
    "ops_observed_metar_wind",
    "winter_storm_levels",
    "nbm_qpf",
  ...
  flag_by_token <- c(
    "Radar | IEM NEXRAD" = "add_ops_conus_radar",
    "Radar | NOAA MRMS" = "add_ops_conus_radar",
    "Delta ops snapshot | CVP/SWP" = "add_ops_delta_ops_daily_summary",
    ...
    "Reservoirs | storage-centric | CDEC / CNRFC / USACE" = "add_ops_cdec_reservoir_storage",
    "NWS weather stations | NWS/WRH time series" = "add_ops_cnrfc_precip_weather_stations",
    "CoCoRaHS | CA daily" = "add_ops_cocorahs_daily_precip",
    "CoCoRaHS | 50-state daily" = "add_ops_cocorahs_daily_precip",
    "Wind flow | NOAA HRRR surface detail" = "add_ops_hrrr_surface_wind",
    "Wind flow | NOAA GFS surface" = "add_ops_gfs_surface_wind",
    "Wind outlook | NOAA NBM guidance" = "add_ops_nbm_wind_guidance",
    "PT_ASOS_WIND_LAYER_NAME" = "add_ops_asos_awos_wind",
    "PT_SNOW_PRODUCT_NAME" = "add_ops_nbm_snow_levels",
    "PT_QPF_PRODUCT_NAME" = "add_ops_nbm_qpf",
    "PT_ACCUM_PRODUCT_NAME" = "add_ops_nbm_accumulated_qpf"
  )
