# scripts/preview_delta_ops_snapshot_v9.R
...
out_html <- "docs/data/delta_ops_snapshot_preview_v9.html"

htmlwidgets::saveWidget(
  m,
  out_html,
  selfcontained = TRUE,
  title = "BRIM Delta Ops Snapshot Preview v9"
)
