...
LOCAL_LAYER_GROUP_ALIASES <- c(
  ...
  "BLM-drilled wells | NOC" = "Points – GW wells | BLM NOC inventory",
  "Points – BLM-drilled wells | NOC" = "Points – GW wells | BLM NOC inventory",
  "Labels – BLM-drilled wells | NOC" = "Labels – GW wells | BLM NOC inventory",
  "BLM-drilled wells | NOC database" = "Points – GW wells | BLM NOC inventory",
  "Points – BLM-drilled wells | NOC database" = "Points – GW wells | BLM NOC inventory",
  "Labels – BLM-drilled wells | NOC database" = "Labels – GW wells | BLM NOC inventory",
  "GW wells | NOC" = "Points – GW wells | BLM NOC inventory",
  "Points – GW wells | NOC" = "Points – GW wells | BLM NOC inventory",
  "Labels – GW wells | NOC" = "Labels – GW wells | BLM NOC inventory",
  "GW wells | 2025 Mojave-BLM field check" = "Points – GW sites | 2025 Mojave limited field inventory",
  "Points – GW wells | 2025 Mojave-BLM field check" = "Points – GW sites | 2025 Mojave limited field inventory",
  "Labels – GW wells | 2025 Mojave-BLM field check" = "Labels – GW sites | 2025 Mojave limited field inventory",
  "GW wells | 2025 Mojave-BLM limited field check" = "Points – GW sites | 2025 Mojave limited field inventory",
  "Points – GW wells | 2025 Mojave-BLM limited field check" = "Points – GW sites | 2025 Mojave limited field inventory",
  "Labels – GW wells | 2025 Mojave-BLM limited field check" = "Labels – GW sites | 2025 Mojave limited field inventory",
