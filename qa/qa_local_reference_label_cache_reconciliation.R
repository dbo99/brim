...
expected_children <- c(
  ...
  "field_office_outer", "acec", "fedwilderness",
...
expected_rows <- c(
  ...
  field_office_outer = 14L, acec = 238L, fedwilderness = 197L,
...
stopifnot(
  ...
  identical(length(production), 16L),
  identical(length(isolated_old), 17L)
)
