...
OUT_DIR <- "output"
OUT_HTML <- file.path(OUT_DIR, "operational_qpe_qpf_layer_test.html")
...
function(el, x) {
  ...
  title.onAdd = function() {
    ...
    div.innerHTML =
      '<div class="big">Operational QPE / QPF Layer Test</div>' +
